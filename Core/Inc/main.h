...
#define DAC_VVAR_BUCK_Pin GPIO_PIN_4
#define DAC_VVAR_BUCK_GPIO_Port GPIOA
#define DAC_5V_BUCK_Pin GPIO_PIN_5
...
#define INA_5VA_ADC3_IN1_Pin GPIO_PIN_1
#define INA_5VA_ADC3_IN1_GPIO_Port GPIOB
